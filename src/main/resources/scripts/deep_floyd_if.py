...
def get_stage(hf_auth_token, stage):
    if stage == 1:
        ...
        def stage_1_fn(prompt, negative_prompt, num_inference_steps, generator):
            ...
            image = stage_1(prompt_embeds=prompt_embeds, negative_prompt_embeds=negative_embeds, generator=generator, num_inference_steps=num_inference_steps, output_type="pt").images
